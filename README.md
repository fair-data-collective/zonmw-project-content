...
`sheet2rdf` and `OntoStack` are used to build and serve **ZonMw COVID19 Controlled Vocabulary**, while PURL is used to provide globaly unique and persistant identifiers for the vocabulary terms and properties:
